...
8. **ทุกหน้าเข้าธีมแล้ว** — Trades, Calendar, Analytics, Profile, Settings,
   Download, User Management, EA Repository, Announce, Login/Sign-up
   - กล่อง/แผงที่เขียน border ตรง ๆ 116 จุด ได้มุมมนเท่ากันหมด
   - หัวข้อการ์ดเปลี่ยนจากสีฟ้าเป็นขาว สีฟ้าเหลือไว้กับปุ่ม/ลิงก์เท่านั้น
   - ฟอนต์พิกเซลที่เขียนตรง ๆ ในคอมโพเนนต์ 70 จุดเปลี่ยนมาใช้ token
     และขนาด 7-10px ที่อ่านไม่ออกด้วยฟอนต์ปกติ ปรับขึ้นตามสเกล
   - การ์ดสรุปหน้า Trades ใช้ทรงเดียวกับการ์ด KPI หน้าแรก
   - กราฟ Equity เปลี่ยนเป็น area chart ไล่เฉดตาม spec, กราฟแท่งมุมมน
...
1. **ฟอนต์ตัวจริง** — Lemon Milk + Termina (ดูวิธีเปลี่ยนข้างบน)
2. **ธีมสว่าง (light) กับธีม HUD** — ยังเป็นชุดสีเดิม ธีมหลัก (dark) เปลี่ยนแล้ว
3. **2 สีที่ spec ไม่ได้ระบุ** — ตอนนี้เลือกให้ก่อนแล้ว: เตือน `#fbbf24` (amber),
